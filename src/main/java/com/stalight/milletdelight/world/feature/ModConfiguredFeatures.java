...
public class ModConfiguredFeatures {
    ...
    public static RegistryKey<ConfiguredFeature<?, ?>> registry(String id) {
        return RegistryKey.of(RegistryKeys.CONFIGURED_FEATURE, Identifier.of(MilletDelight.MODID, id));
    }
    ...
    public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> context) {
        register(context, WILD_MILLET, Feature.RANDOM_PATCH,
                ConfiguredFeatures.createRandomPatchFeatureConfig(64, PlacedFeatures.createEntry(Feature.SIMPLE_BLOCK,
                        new SimpleBlockFeatureConfig(BlockStateProvider.of(ModBlocks.WILD_MILLET)))));
    }
