...
public class ModRecipeGeneration extends RecipeProvider {

    public ModRecipeGeneration(PackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
    ...
    public void potting(RecipeOutput output) {
        ...
        CookingPotRecipeBuilder.cookingPotRecipe(MilletItems.MILLET_RICE, 1, 200, 1.0F, Items.BOWL)
                ...
                .addIngredient(DataComponentIngredient.of(true, DataComponents.POTION_CONTENTS, new PotionContents(Potions.WATER), Items.POTION))
                .setRecipeBookTab(CookingPotRecipeBookTab.MEALS)
    ...
    public void crafting(RecipeOutput output) {
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, MilletItems.WHEAT_WINE)
                ...
                .requires(DataComponentIngredient.of(true, DataComponents.POTION_CONTENTS, new PotionContents(Potions.WATER), Items.POTION))
