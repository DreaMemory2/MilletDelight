...
public class ModChineseGenerator extends FabricLanguageProvider {
    ...
    public ModChineseGenerator(FabricPackOutput dataOutput, CompletableFuture<HolderLookup.Provider> registryLookup) {
        super(dataOutput, "zh_cn", registryLookup);
    }

    @Override
    public void generateTranslations(HolderLookup.@NotNull Provider provider, @NotNull TranslationBuilder builder) {
        /* 方块 */
        block(builder);
        /* 物品 */
        item(builder);
