...
public class ModItemTagGeneration extends FabricTagsProvider.ItemTagsProvider {

    public ModItemTagGeneration(FabricPackOutput output, CompletableFuture<HolderLookup.Provider> completableFuture) {
        super(output, completableFuture);
    }

    @Override
    protected void addTags(HolderLookup.Provider provider) {
        this.valueLookupBuilder(MilletTags.MILLET_PASTRY)
        ...
        this.valueLookupBuilder(MilletTags.MILLET_BISCUIT)
        ...
        this.valueLookupBuilder(ModTags.Items.KNIVES)
                .add(MilletItems.MILLET_KNIFE);
        this.valueLookupBuilder(ICommonTags.EGG)
                .add(Items.EGG);
    }
}
